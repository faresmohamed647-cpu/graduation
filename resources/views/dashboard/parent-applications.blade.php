...
<body>
    <div class="dash-header">
        ...
        <div class="header-actions">
            <a href="{{ url('/apply/parent') }}" class="header-btn primary"><i class="fas fa-plus"></i> New Application</a>
    ...
    <div class="dash-content">
        ...
        <div class="empty-state">
            ...
            <a href="{{ url('/apply/parent') }}" class="header-btn primary"><i class="fas fa-plus"></i> Submit Application</a>
        </div>
        @endif
    </div>
