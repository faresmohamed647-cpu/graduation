        ...
        <div class="container text-center py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4">Bus Route Not Found</h1>
                    <p class="mb-4">The page you're looking for doesn't exist.Please return to the home page or track your school bus safely.</p>
