  ...
  <script>
    renderAddForm({
      ...
      fields: [
        ...
        { name: 'children', label: 'Children Names', placeholder: 'Ahmed, Laila', required: true, width: 'half' },
        { name: 'status', label: 'Status', type: 'select', required: true, options: [{ value: 'active', label: 'Active' }, { value: 'inactive', label: 'Inactive' }, { value: 'pending', label: 'Pending' }] },
